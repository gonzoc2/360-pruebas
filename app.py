...
if st.session_state.get("pagina_actual") == "PorProyectos":
    st.title("PorProyectos")
    st.write("Esta página no está en el menú, pero es parte de la app.")

if st.button("Ver página PorProyectos"):
    st.session_state.pagina_actual = "PorProyectos"

if st.session_state.get("pagina_actual") == "PorProyectos":
    st.title("PorProyectos")
    st.write("Contenido de la página especial.")
